...
void main(){
    ...
    //best case
    if(readFromFile("C:/lab practice/sem 5/DAA/Array/best_case_1000.txt" , arr , N)){
        start = clock();
        heapSort(arr , N);
        end = clock();
     ...
     //average case
    if(readFromFile("C:/lab practice/sem 5/DAA/Array/average_case_1000.txt" , arr , N)){
        start = clock();
        heapSort(arr , N);
        end = clock();
        time_taken = ((double)end-start) /  CLOCKS_PER_SEC  * 1000;
    ...
    //worst case
    if(readFromFile("C:/lab practice/sem 5/DAA/Array/worst_case_1000.txt", arr , N)){
        start = clock();
        heapSort(arr , N);
        end = clock();
        time_taken = ((double)(end-start)) /  CLOCKS_PER_SEC  * 1000;
