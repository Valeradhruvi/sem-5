...
class StudentGetView extends StatefulWidget {
  const StudentGetView({super.key});

  @override
  State<StudentGetView> createState() => _StudentGetViewState();
}

class _StudentGetViewState extends State<StudentGetView> {
  ...
  Future<void> _loadStudents() async {
    studentList = await controller.getAllStudent();
    setState(() {});
  }
